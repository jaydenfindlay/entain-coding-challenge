...
var (
	...
	grpcEndpoint       = flag.String("grpc-endpoint", "localhost:9000", "gRPC racing server endpoint")
	sportsGrpcEndpoint = flag.String("sports-grpc-endpoint", "localhost:9001", "gRPC sports server endpoint")
)
